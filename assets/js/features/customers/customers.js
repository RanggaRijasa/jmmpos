      ...
      return `
        <div class="reminder-row">
          ...
          <div class="reminder-actions">
            ...
            <button class="reminder-whatsapp" type="button" aria-label="WhatsApp untuk ${customerReminderEscape(reminder.customer)}" title="WhatsApp">
              <svg viewBox="0 0 24 24" aria-hidden="true">
                <path d="M20.5 11.7a8.5 8.5 0 0 1-12.6 7.4L3 20.5l1.4-4.7a8.5 8.5 0 1 1 16.1-4.1Z"></path>
                <path d="M8.3 7.8c.2-.4.4-.4.7-.4h.5c.2 0 .4.1.5.4l.8 1.8c.1.3.1.5-.1.7l-.6.7c-.2.2-.1.4 0 .6.7 1.3 1.7 2.2 3 2.8.2.1.4.1.6-.1l.8-1c.2-.2.4-.3.7-.2l1.8.8c.3.1.4.3.4.5 0 .4-.2 1.4-.9 2-.6.5-1.4.8-2.4.6-1.2-.2-2.8-.8-4.6-2.4-2.1-1.9-3.3-4.2-3.4-5.5 0-.6.1-1 .2-1.3Z"></path>
              </svg>
            </button>
          </div>
        </div>`;
